...
const setupWS = (provider) => {
	if (provider.shouldConnect && provider.ws === null) {
		...
		websocket.onopen = () => {
			...
			if (!provider.readonly && provider.awareness.getLocalState() !== null) {
...
export class WebsocketProvider extends Observable {
	 ...
	 * @param {boolean} [opts.readonly] if we shouldn't write awareness or updates back to sync server
	 */
	constructor(
		serverUrl,
		roomname,
		...
		console.log('websocket readonly', readonly);
